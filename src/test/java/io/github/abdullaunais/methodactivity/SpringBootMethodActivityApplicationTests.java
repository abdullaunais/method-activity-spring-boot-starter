package io.github.abdullaunais.methodactivity;

import io.github.abdullaunais.methodactivity.autoconfigure.EnableMethodActivity;
import io.github.abdullaunais.methodactivity.test.service.TestService;
...
class SpringBootMethodActivityApplicationTests {
    ...
    @Test
    void testPreActivityWithBaseParams() {
        testService.invokePreActivityWithBaseParams("Hello", "World");
        assertEquals(messageStack.size(), 1);
        assertEquals(messageStack.pop(), "TestService.invokePreActivityWithBaseParams(Hello, World)");
    }
    ...
    void testPostActivityExecutionTimeCalculation() {
        String testReturn = testService.invokePostActivityExecutionTimeCalculation();
        assertEquals(testReturn, "bla bla blah");
        assertEquals(messageStack.size(), 1);
